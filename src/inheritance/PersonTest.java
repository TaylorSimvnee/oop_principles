...
public class PersonTest {
    public static void main(String[] args) {
        ...
        personArrayList.add(tester2);
        personArrayList.add(singer2);
        personArrayList.add(dancer2);

        System.out.println();

        personArrayList.forEach(element -> System.out.println(element));
